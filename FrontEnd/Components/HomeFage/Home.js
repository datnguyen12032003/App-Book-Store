...
import { StyleSheet, StatusBar, ScrollView, View, ImageBackground, Text, TouchableOpacity } from 'react-native';
...
const Home = ({ navigation }) => {
  ...
  return (
    <ImageBackground
      source={require('../../../../App-Book-Store/FrontEnd/assets/Images/onboarding/orangebackgroung.jpg')} // Đường dẫn đến hình nền
      style={styles.background}
      resizeMode="cover" // Thay đổi cách hiển thị hình ảnh nền
    >
      <View style={styles.wrapper}>
        <ImageBackground
          source={require('../../../../App-Book-Store/FrontEnd/assets/Images/onboarding/pngtree-white-book-pages-png-file-png-image_10162601.png')}
          style={styles.image}
